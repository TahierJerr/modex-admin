...
const ScrapeForm = () => {
    ...
    // Logging raw minPrice and converting to numbers
                ...
                <div className="product-data mt-8 p-4 border rounded-lg bg-gray-100">
                    <div>
                        ...
                        <p>
                            ...
                            <a href={productData.productUrl} target="_blank" rel="noopener noreferrer" className="text-blue-500">
                    ...
                    <div className="mt-2">
                        {chartData && (
                            <PriceChart 
                                yAxisMax={Math.max(...chartData.map(item => item.avgPrice), avgPriceNumber)} 
                                yAxisMin={calculatedYAxisMin} 

...
export const CellAction: React.FC<CellActionProps> = ({
    ...
    const onCopy = (id: string) => {
        ...
        toast.success("PSU Id Route copied to clipboard.");
        ...
        const onDelete = async () => {
            try {
                setLoading(true);
                await axios.delete(`/api/${params.storeId}/power/${data.id}`);
                router.refresh();
                router.push(`/${params.storeId}/power`);
                toast.success("PSU deleted.");
            } catch (error) {
    ...
    return (
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={() => router.push(`/${params.storeId}/power/${data.id}`)}>

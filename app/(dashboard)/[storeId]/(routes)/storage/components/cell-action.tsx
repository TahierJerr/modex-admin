...
export const CellAction: React.FC<CellActionProps> = ({
    ...
    const onCopy = (id: string) => {
        ...
        toast.success("Storage Id Route copied to clipboard.");
        ...
        const onDelete = async () => {
            try {
                setLoading(true);
                await axios.delete(`/api/${params.storeId}/storage/${data.id}`);
                router.refresh();
    ...
    return (
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={() => router.push(`/${params.storeId}/storage/${data.id}`)}>
